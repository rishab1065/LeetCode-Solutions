  ...
  if (!cycleFound) {
    ...
    for (var i = 0; i < numCourses; i++) {
      ...
      if (!totalVisitedCourse[i]) {
        response = dfs(courseMap, i, visitedCourse, totalVisitedCourse);
      }
      if (!response) break;
    }
    return response;
...
var dfs = (courseMap, course, visitedCourse, totalVisitedCourse) => {
  ...
  for (var i = 0; i < courseMap.length; i++) {
    ...
    if (
      courseMap[i][course] === 1 &&
      courseMap[course][i] === 0
      //   ||
      //   (courseMap[i][course] === 0 && courseMap[course][i] === 1)
    ) {
      // console.log(i, course, 'hello');
      value = value && dfs(courseMap, i, visitedCourse, totalVisitedCourse);
    }
  }
